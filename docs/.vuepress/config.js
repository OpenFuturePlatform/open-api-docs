module.exports = {
    ...
    head: [
        ...
        ['script', {}, 'window.onload = function() {const currentYear = new Date().getFullYear();document.getElementsByClassName("footer")[0].innerHTML = `© ${currentYear} OPEN. All Rights Reserved`};']
    ],
    dest: 'public',
    themeConfig: {
